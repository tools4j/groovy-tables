...
class TestClassGenerator {
    ...
    static void generateSimpleTableParserFirstTwoArgsTest() {
        ...
        sb.append("package org.tools4j.groovytabledsl\n" +
                "\n" +
                "import spock.lang.Specification\n" +
                "import org.tools4j.groovytabledsl.model.SimpleClass\n" +
                "\n" +
                "import static org.tools4j.groovytabledsl.TestUtils.assertActualEqualsExpected\n" +
                "\n" +
                "\n" +
        ...
        sb.append("    }\n}");
        writeToFile("src/generatedtest/groovy/org/tools4j/groovytabledsl/SimpleTableParserFirstTwoArgsTest.groovy", sb.toString())
    }
    ...
    static void generateSimpleTableParserSubsequentTwoArgsTest() {
        ...
        sb.append(assertSb.toString())
        sb.append("    }\n}");
        writeToFile("src/generatedtest/groovy/org/tools4j/groovytabledsl/SimpleTableParserSubsequentTwoArgsTest.groovy", sb.toString())
    }
    ...
    static void generateSimpleTableParserSubsequentTwoArrayArgsTest() {
        ...
        sb.append(assertSb.toString())
        sb.append("    }\n}");
        writeToFile("src/generatedtest/groovy/org/tools4j/groovytabledsl/SimpleTableParserSubsequentTwoArrayArgsTest.groovy", sb.toString())
    }
}
